...
public class Sieve {
    ...
    public static void printsieve(int[] results, boolean[] prime) {
		...
		isPrime = prime[j] ? 'T' : 'F';
		System.out.print(results[j] + "(" + isPrime + ") ");
		j++;
	    }
	    System.out.println();
    }
    ...
    /**
     * Creates and returns an array of size s that is all true values.
     * @param arraySize the size of the array to return
     */
    
    public static boolean[] getTrueArray(int arraySize) {
	boolean[] toReturn = new boolean[arraySize];
